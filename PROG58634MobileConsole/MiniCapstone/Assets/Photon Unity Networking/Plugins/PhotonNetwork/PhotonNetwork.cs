...
public static class PhotonNetwork
{
    ...
    public static void AdditiveLoadLevel(int levelNumber)
    {
        if (PhotonNetwork.automaticallySyncScene)
        {
            networkingPeer.SetLevelInPropsIfSynced(levelNumber);
    ...
    public static AsyncOperation AdditiveLoadLevelAsync(int levelNumber)
    {
        if (PhotonNetwork.automaticallySyncScene)
        {
            networkingPeer.SetLevelInPropsIfSynced(levelNumber, true);
        ...
        PhotonNetwork.isMessageQueueRunning = false;
        networkingPeer.loadingLevelAndPausedNetwork = true;
        return SceneManager.LoadSceneAsync(levelNumber, LoadSceneMode.Additive);
    }
    ...
    public static void AdditiveLoadLevel(string levelName)
    {
        if (PhotonNetwork.automaticallySyncScene)
        {
            networkingPeer.SetLevelInPropsIfSynced(levelName);
    ...
    public static AsyncOperation AdditiveLoadLevelAsync(string levelName)
    {
        if (PhotonNetwork.automaticallySyncScene)
        {
            networkingPeer.SetLevelInPropsIfSynced(levelName, true);
