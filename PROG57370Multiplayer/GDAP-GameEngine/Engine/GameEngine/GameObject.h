...
public:
	virtual void writeCreate(RakNet::BitStream& bs) const final;
	virtual void readCreate(RakNet::BitStream& bs) final;

	virtual void writeUpdate(RakNet::BitStream& bs) const final;
	virtual void readUpdate(RakNet::BitStream& bs) final;
