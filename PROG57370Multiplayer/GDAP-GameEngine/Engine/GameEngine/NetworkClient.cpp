...
void NetworkClient::sendPacket(RakNet::BitStream& bs, PacketPriority priority)
{
	rakInterface->Send(&bs, priority, RELIABLE_ORDERED, 0, serverGUID, false);
}
...
void NetworkClient::clientUpdate()
{
	...
	while(packet != nullptr)
	{
		...
		switch (packetId) 
		{
			...
			case MSG_SNAPSHOT:
				GameObjectManager::Instance().readCreateSnapShot(bs);
				break;
