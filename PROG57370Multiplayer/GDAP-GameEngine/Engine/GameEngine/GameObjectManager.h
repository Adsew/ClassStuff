...
public:
	...
	// Networking
	void writeGameObjectUpdate(RakNet::BitStream& bs, GameObject* gameObject);
	void writeCreateSnapShot(RakNet::BitStream& bs);
	void readCreateSnapShot(RakNet::BitStream& bs);
