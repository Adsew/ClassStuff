...
Model::Model(Shader &shader, GLfloat verts[], GLfloat norms[], GLfloat cols[], int vCount, const char *textureLocation) {
    ...
    // Texture loading
    tex = new Texture(textureLocation);
...
Model::Model(Shader &shader, const char *file, const char *textureLocation) {
